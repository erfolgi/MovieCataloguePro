...
class TestRepository(var remoteData: RemoteDataSource,
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource,localDataSource: LocalDataSource,appExecutors: AppExecutors): TestRepository? {
            if (INSTANCE == null) {
                synchronized(TestRepository::class.java) {
                    if (INSTANCE == null) {
                        INSTANCE =
                            TestRepository(remoteData,localDataSource,appExecutors)
                    }
                }
            }
