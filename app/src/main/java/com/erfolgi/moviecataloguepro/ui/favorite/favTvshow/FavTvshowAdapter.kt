...
class FavTvshowAdapter : PagedListAdapter<TVEntity, FavTvshowAdapter.FavTvshowViewHolder>(DIFF_CALLBACK) {
    companion object {
    ...
    override fun onBindViewHolder(holder: FavTvshowViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            i.putExtra(TvShowDetailActivity.EXTRA_TV_ID,mTvShows.id.toString())
